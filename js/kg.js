initKG = function (data, config, container) {
    ...
    if (!config.nodeColor || config.nodeColor === "")
        var defaultNodeColor = [
            //人物，蓝色
            { fill: "rgb(249, 235, 249)", stroke: "#3066cb", text: "#3066cb" },
            //共同体，#03aee9
            { fill: "#ccc", stroke: "#03aee9", text: "#03aee9" },
            //文献，#e99e35
            { fill: "rgb(112, 202, 225)", stroke: "#e99e35", text: "#e99e35" },
            //事件，#d05878
            { fill: "#D9C8AE", stroke: "#d05878", text: "#d05878" },
            //地点, #28c8af
            { fill: "rgb(178, 229, 183)", stroke: "#28c8af", text: "#28c8af" },
            //红
    ...
    var marker =
        ...
        svg.append("marker")
            ...
            .append("path")
            .attr("d", "M0,-3L8,0L0,3")//绘制箭头，路径为一个三角形，有疑问参考svg的path http://www.runoob.com/svg/svg-path.html
            .attr('fill', '#7fa3b5');//箭头颜色
    ...
    defs.append('pattern')
            ...
            .attr('height', 102)
          .append('svg:image')
            .attr('xlink:href', 'https://dhc.library.sh.cn/uc/img/1.png')
            .attr("width",72)
            .attr("height",72)
            .attr("x", 0)
            .attr("y", 0);
    ...
    defs.append('pattern')
            ...
            .attr('height', 72)
          .append('svg:image')
            .attr('xlink:href', 'https://dhc.library.sh.cn/uc/img/2.png')
            .attr("width",72)
            .attr("height",72)
            .attr("x", 0)
            .attr("y", 0);
    ...
    defs.append('pattern')
            ...
            .attr('height', 72)
          .append('svg:image')
            .attr('xlink:href', 'https://dhc.library.sh.cn/uc/img/org.png')
            .attr("width",72)
            .attr("height",72)
            .attr("x", 0)
            .attr("y", 0);
    ...
    function tick() {//刷新页面函数
        ...
        edges_line.attr('d', function (d) { //连接线
            var path = 'M ' + (d.source.x+36) + ' ' + (d.source.y+36) + ' L ' + (d.target.x+36) + ' ' + (d.target.y+36);
            return path;
        });
